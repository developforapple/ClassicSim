...
TestMainhandAttackWarrior::TestMainhandAttackWarrior(EquipmentDb* equipment_db) : TestSpellWarrior(equipment_db, "MainhandAttackWarrior") {}
...
MainhandAttackWarrior* TestMainhandAttackWarrior::mh_attack() const {
    auto spells = static_cast<WarriorSpells*>(warrior->get_spells());
    return static_cast<MainhandAttackWarrior*>(spells->get_mh_attack());
}
...
void TestMainhandAttackWarrior::test_how_spell_observes_global_cooldown() {
...
void TestMainhandAttackWarrior::test_whether_spell_causes_global_cooldown() {
