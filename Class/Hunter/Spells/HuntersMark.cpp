...
HuntersMark::HuntersMark(Character* pchar, HuntersMarkBuff* hunters_mark) :
    Spell(QObject::tr("Hunter's Mark"),
          ...
          ResourceType::Mana,
          60),
    TalentRequirer(QVector<TalentRequirerInfo*> {new TalentRequirerInfo(QObject::tr("Improved Hunter's Mark"), 5, DisabledAtZero::No)}),
...
void HuntersMark::increase_talent_rank_effect(const QString& talent_name, const int curr) {
    if (talent_name == QObject::tr("Improved Hunter's Mark"))
