...
Rogue::Rogue(Race* race_, EquipmentDb* equipment_db, SimSettings* sim_settings_, RaidControl* raid_control_, const int party_, const int member) :
    ...
    this->mh_instant_poison = new InstantPoison(this, enchant_info, QObject::tr("MH"), EnchantSlot::MAINHAND);
    this->oh_instant_poison = new InstantPoison(this, enchant_info, QObject::tr("OH"), EnchantSlot::OFFHAND);
