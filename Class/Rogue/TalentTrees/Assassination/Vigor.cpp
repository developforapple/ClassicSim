...
Vigor::Vigor(Rogue* rogue, TalentTree* tree_) :
    Talent(rogue, tree_, QObject::tr("Vigor"), "7ML", "Assets/spell/Spell_nature_earthbindtotem.png", 1), rogue(rogue) {
    QString base_str = QObject::tr("Increases your maximum Energy by 10.");
