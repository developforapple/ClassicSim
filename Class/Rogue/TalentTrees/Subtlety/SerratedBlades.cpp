...
SerratedBlades::SerratedBlades(Character* pchar, TalentTree* tree) :
    Talent(pchar, tree, QObject::tr("Serrated Blades"), "4MR", "Assets/items/Inv_sword_17.png", 3) {
    QString base_str = QObject::tr("Causes your attacks to ignore %1 of your target's Armor and increases the damage dealt by your Rupture ability by %2%. The "
