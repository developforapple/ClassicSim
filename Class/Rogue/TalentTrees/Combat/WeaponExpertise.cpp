...
WeaponExpertise::WeaponExpertise(Character* pchar, TalentTree* tree) :
    Talent(pchar, tree, QObject::tr("Weapon Expertise"), "6ML", "Assets/spell/Spell_holy_blessingofstrength.png", 2) {
    QString base_str = QObject::tr("Increases your skill with Sword, Fist and Dagger weapons by %1.");
