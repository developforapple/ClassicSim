...
FistWeaponSpecialization::FistWeaponSpecialization(Character* pchar, TalentTree* tree) :
    Talent(pchar, tree, QObject::tr("Fist Weapon Specialization"), "5RR", "Assets/items/Inv_gauntlets_04.png", 5) {
    QString base_str = QObject::tr("Increases your chance to get a critical strike with Fist Weapons by %1%.");
