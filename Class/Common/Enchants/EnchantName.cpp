...
EnchantInfo::EnchantInfo() {
    enchant_specs = {
        ...
        new EnchantSpec(EnchantName::Name::EnchantGlovesShadowPower, QObject::tr("Shadow Power", "Enchant Gloves Shadow Power"), QObject::tr("Enchant Gloves - Shadow Power"), QObject::tr("+20 Shadow Damage")),
        ...
        new EnchantSpec(EnchantName::Name::HoodooHex, QObject::tr("Hoodoo Hex"), QObject::tr("Hoodoo Hex"), QObject::tr("+18 Spell Damage/Healing\n+10 Stamina")),
