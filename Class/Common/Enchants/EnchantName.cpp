...
EnchantInfo::EnchantInfo() {
    enchant_specs = {
        ...
        new EnchantSpec(EnchantName::Name::EnchantBracerManaRegeneration, QObject::tr("Mana Regeneration"), QObject::tr("Enchant Bracer - Mana Regeneration"), QObject::tr("+4 mp5")),
        new EnchantSpec(EnchantName::Name::EnchantBracerMinorAgility, QObject::tr("Minor Agility", "Enchant Bracer Minor Agility"), QObject::tr("Enchant Bracer - Mana Regeneration"), QObject::tr("+4 mp5")),
        ...
        new EnchantSpec(EnchantName::Name::EnchantChestMajorMana, QObject::tr("Major Mana", "Enchant Chest MajorMana"), QObject::tr("Enchant Chest - Major Mana"), QObject::tr("+100 Mana")),
        ...
        new EnchantSpec(EnchantName::Name::EnchantGlovesFirePower, QObject::tr("Fire Power"), QObject::tr("Enchant Gloves - Fire Power"), QObject::tr("+20 Fire Damage")),
        new EnchantSpec(EnchantName::Name::EnchantGlovesFrostPower, QObject::tr("Frost Power"), QObject::tr("Enchant Gloves - Frost Power"), QObject::tr("+20 Frost Damage")),
        ...
        new EnchantSpec(EnchantName::Name::EnchantGlovesMinorHaste, QObject::tr("Minor Haste"), QObject::tr("Enchant Gloves - Minor Haste"), QObject::tr("+1% Attack Speed")),
