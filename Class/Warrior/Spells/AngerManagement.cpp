...
AngerManagement::AngerManagement(Warrior* warrior, WarriorSpells* warrior_spells) :
    PeriodicResourceGainSpell(QObject::tr("Anger Management"),
                              ...
                              {{ResourceType::Rage, 1}}),
    TalentRequirer(QVector<TalentRequirerInfo*> {new TalentRequirerInfo(QObject::tr("Anger Management"), 1, DisabledAtZero::Yes)}),
    warrior(warrior),
