...
TacticalMastery::TacticalMastery(Warrior* warrior, TalentTree* tree_) :
    Talent(warrior, tree_, QObject::tr("Tactical Mastery"), "2ML", "Assets/spell/Spell_nature_enchantarmor.png", 5), warrior(warrior) {
    QString base_str = QObject::tr("You retain up to %1 of your rage points when you change stances.");
