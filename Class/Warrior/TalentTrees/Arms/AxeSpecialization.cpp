...
AxeSpecialization::AxeSpecialization(Warrior* warrior, TalentTree* tree_) :
    Talent(warrior, tree_, QObject::tr("Axe Specialization"), "5LL", "Assets/items/Inv_axe_06.png", 5) {
    QString base_str = QObject::tr("Increases your chance to get a critical strike with Axes by %1%.");
